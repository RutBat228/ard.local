                ...
                <div class="list-group">
                    <div class="list-group-item p-0 border-0">
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="ya_kalendar.php?date=<?= $date_blyat ?>" class="calendar-button">
                                <i class="fa-solid fa-calendar-days me-2"></i> Общий календарь дежурств
                            </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <p>Количество дежурств: <span id="dutyCount">0</span></p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toastr.options = {
        ...
        timeOut: 2000, // Уведомление исчезает через 2 секунды
    ...
    function loadDutiesAndHolidays(userId, month) {
        ...
        .then(([dutiesData, holidaysData, financeData]) => {
            ...
            console.log("Loaded duties:", Array.from(selectedDates));
        })
        .catch(error => {
            ...
            updateDutyCount();
            generateCalendar(month);
            toastr.error('Ошибка при загрузке данных: ' + error.message, 'Ошибка');
        });
    }
    ...
    function updateDutyCount() {
        ...
        selectedDates.forEach(date => {
            ...
            dutyCount += (isHoliday && isWeekend) ? 2 : 1;
        });
    ...
    function generateCalendar(month) {
        ...
        const firstDayOfMonth = new Date(year, parseInt(monthNum) - 1, 1);
        ...
        for (let day = 1; day <= lastDay; day++) {
            ...
            const currentDate = new Date(year, parseInt(monthNum) - 1, day);
    ...
    document.getElementById('saveDuties').addEventListener('click', function() {
        ...
        .then(data => {
            if (data.success) {
                toastr.success('Дежурства и аванс сохранены', 'Успех!');
                setTimeout(() => {
                    bootstrap.Modal.getInstance(document.getElementById('dutyModal')).hide();
                    location.reload();
                }, 2000);
            } else {
                toastr.error('Ошибка при сохранении: ' + data.error, 'Ошибка');
            }
        })
        .catch(error => {
            toastr.error('Произошла ошибка при запросе: ' + error.message, 'Ошибка');
        });
    });
        ...
        link.addEventListener('click', function(event) {
            ...
            fetch(`get_finance.php?user_id=${settingsUserId}&month=${settingsMonth}`)
                ...
                .catch(error => {
                    ...
                    toastr.error('Ошибка загрузки настроек: ' + error.message, 'Ошибка');
                });
        });
    });
    ...
    document.getElementById('saveSettings').addEventListener('click', function() {
        ...
        .then(data => {
            if (data.success) {
                toastr.success('Настройки сохранены', 'Успех!');
                setTimeout(() => {
